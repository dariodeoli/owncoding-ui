...
// Paleta efectiva del scope v2: la base del tema y encima sus overrides.
const PALETAS = {
  'claro (v2)': [':root {', '.tema-v2,'],
  'oscuro (v2)': ['html.dark {', 'html.dark .tema-v2,'],
}
...
describe('contraste AA del scope v2', () => {
